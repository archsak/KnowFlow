...
def train_and_save_model(training_df: pd.DataFrame, model_output_path: str, perform_grid_search: bool = False):
    """
    Trains a classification model and saves it.

    Args:
        training_df: DataFrame with features and 'human_rank' as the label.
...
def main():
    ...
    print(f"Loading data from ranked pages directory: {ranked_pages_dir}")
